...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        if self.has_word_attn:
            ...
            # z 
            layer_output = layer_output + weighted_word_embedding + inter_word_outputs
...
class ZWCBertModel_v3(BertPreTrainedModel):
    def __init__(self, config, add_pooling_layer=True):
        super(ZWCBertModel_v3, self).__init__(config)
